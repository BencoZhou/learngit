...
#define S1S2DEVICE_TOTAL_NUMBER             (10)    // S1S2共10个设备
...
void S1S2ParaInit(void)
{
    ...
    gS1S2ControlPara[0].cDevice.place.type = DEVICE_NAME_TOWERS_OUT;
    gS1S2ControlPara[0].cDevice.place.area = DEVICE_AREA_S;
    gS1S2ControlPara[0].cDevice.place.mainLine = 1;
    gS1S2ControlPara[0].cDevice.place.viceLine = 10;
    gS1S2ControlPara[1].cDevice.place.type = DEVICE_NAME_TOWERS_OUT;
    gS1S2ControlPara[1].cDevice.place.area = DEVICE_AREA_S;
    gS1S2ControlPara[1].cDevice.place.mainLine = 1;
	gS1S2ControlPara[1].cDevice.place.viceLine = 20;
	gS1S2ControlPara[2].cDevice.place.type = DEVICE_NAME_FLINE;
	gS1S2ControlPara[2].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[2].cDevice.place.mainLine = 1;
	gS1S2ControlPara[2].cDevice.place.viceLine = 0;
	gS1S2ControlPara[3].cDevice.place.type = DEVICE_NAME_MAIN_VICE;
	gS1S2ControlPara[3].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[3].cDevice.place.mainLine = 1;
	gS1S2ControlPara[3].cDevice.place.viceLine = 20;
	gS1S2ControlPara[4].cDevice.place.type = DEVICE_NAME_FLINE;
	gS1S2ControlPara[4].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[4].cDevice.place.mainLine = 2;
	gS1S2ControlPara[4].cDevice.place.viceLine = 0;
	gS1S2ControlPara[5].cDevice.place.type = DEVICE_NAME_IN_TOWERS;
	gS1S2ControlPara[5].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[5].cDevice.place.mainLine = 2;
	gS1S2ControlPara[5].cDevice.place.viceLine = 10;
	gS1S2ControlPara[6].cDevice.place.type = DEVICE_NAME_IN_TOWERS;
	gS1S2ControlPara[6].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[6].cDevice.place.mainLine = 2;
	gS1S2ControlPara[6].cDevice.place.viceLine = 10;
	gS1S2ControlPara[7].cDevice.place.type = DEVICE_NAME_IN_TOWERS;
	gS1S2ControlPara[7].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[7].cDevice.place.mainLine = 2;
	gS1S2ControlPara[7].cDevice.place.viceLine = 10;
	gS1S2ControlPara[8].cDevice.place.type = DEVICE_NAME_IN_TOWERS;
	gS1S2ControlPara[8].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[8].cDevice.place.mainLine = 2;
	gS1S2ControlPara[8].cDevice.place.viceLine = 10;
	gS1S2ControlPara[9].cDevice.place.type = DEVICE_NAME_IN_TOWERS;
	gS1S2ControlPara[9].cDevice.place.area = DEVICE_AREA_S;
	gS1S2ControlPara[9].cDevice.place.mainLine = 2;
	gS1S2ControlPara[9].cDevice.place.viceLine = 10;
}
