...
void ControlMsgBoxInit(void)
{
    ...
    gControlRc_Queue = OS_MsgBoxCreate("Rc_Queue", sizeof(INPUT_EVENT), 3);
...
void ControlSend_Task(void *Task_Parameters)
{
    ...
    while (1)
    {
        ...
        evt.Info.b[0] = gFlineCtrlSeq - 1;
        OS_MsgBoxSend(gControlSendSeq_Queue, &evt, OS_NO_DELAY, FALSE);
