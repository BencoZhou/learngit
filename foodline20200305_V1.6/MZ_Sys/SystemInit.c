...
void *FoodlineStateMachine_Task_Handle = NULL;
...
void MZ_SYS_Init(void)
{
	...
	OS_TaskCreate(StateMachine_Task, "StateMachine", OS_MINIMAL_STACK_SIZE*(4+1), NULL, FOODLINE_STATEMACHINE_PRIORITY, &FoodlineStateMachine_Task_Handle);
